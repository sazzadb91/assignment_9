<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light py-4 shadow-sm bg-white sticky-top">
        <div class="container">
          <a class="navbar-brand" href="{{route('home')}}">
            <img class="img-fluid" src="bootstrap5-plain-assets/logos/logo.jpg" alt="" width="96px">
          </a>
          ...
          <div class="collapse navbar-collapse" id="nav06">
            <ul class="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
              ...
              <li class="nav-item me-4"><a class="nav-link" href="{{route('project')}}">Projects</a></li>
